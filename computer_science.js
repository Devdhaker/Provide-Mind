...
const topics = [
    {
        title: "Mathematics",
        link: "./com/tophic1.html", // Address to the Mathematics page
    },
    {
        title: "Physics",
        link: "./com/tophic2.html", // Address to the Physics page
    },
    {
        title: "Chemistry",
        link: "./com/tophic3.html", // Address to the Chemistry page
    },
    {
        title: "Biology",
        link: "./com/tophic4.html", // Address to the Biology page
    },
    {
        title: "Computer Science",
        link: "./com/tophic5.html", // Address to the Computer Science page
    },
];
